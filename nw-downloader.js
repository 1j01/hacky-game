var Promise = require('nw-builder/node_modules/bluebird');
var request = require('nw-builder/node_modules/request');
var progress = require('nw-builder/node_modules/progress');
var fs = require('fs');
var path = require('path');
var zlib = require('nw-builder/node_modules/zlib');
var tar = require('nw-builder/node_modules/tar-fs');
var temp = require('nw-builder/node_modules/temp');
var DecompressZip = require('nw-builder/node_modules/decompress-zip');
var cpr = require('cpr');
var rimraf = require('nw-builder/node_modules/rimraf');
...
module.exports = {
    ...
    stripRootFolder: function(extracted){
        ...
        if(rootFiles.length === 1 && fs.statSync(fromDir).isDirectory() ){
            ...
            cpr(fromDir, destination, function (err) {
                if (err) done.reject();
